...
**Agent 安装（零人工）**：把本仓库链接发给你的智能体即可——它会读取 `skills/pyaissh/SKILL.md` 并按需安装技能包，或从 [Releases](https://github.com/huajiao1998/pyaissh/releases) 下载最新 zip。

**For agents**: just send this repo URL to your agent — it reads `skills/pyaissh/SKILL.md` and installs the skill itself, or grabs the latest release zip.
...
### 🤖 AI 自助安装（复制给任意 AI 会话，让 AI 自己装）

把下面这段发给你的智能体即可，它会自动完成下载、放置、装依赖、验证：
